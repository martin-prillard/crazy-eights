...
/**
* Viewer permettant de visualiser l'objet image selectioné par le joueur dans le JOptionPane
* 
* Source : developpez.com
*/
@SuppressWarnings("serial")
public class AccesFileChooser extends JPanel
